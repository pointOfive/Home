...
\begin{tabular}{|r||l|l|l|l|}
\hline
$\textcolor{white}{\mathbf{S}}\mathbf{\Sigma_{p \times p}}$ & $X_1$ & $X_2$ & $\cdots$ & $X_p$ \\  \hline  \hline
...
\begin{tabular}{|r||l|l|l|l|}
\hline
 $\textcolor{white}{\mathbf{\Sigma}}\mathbf{r_{p \times p}}$ & $X_1$ & $X_2$ & $\cdots$ & $X_p$ \\  \hline\hline
...
$\displaystyle  {\boldsymbol S} = \frac{1}{n-1}{\boldsymbol X}^T{\boldsymbol X} =  \frac{1}{n-1} \sum_{i=1}^n X_{i\cdot} X_{i\cdot}^T
\quad\quad\quad\quad\;\; \hat  {\boldsymbol r} = \hat {\boldsymbol D}_S^{-\frac{1}{2}}\hat {\boldsymbol S} \hat {\boldsymbol D}_S^{-\frac{1}{2}}$
...
\begin{tabular}{|r||l|l|l|l|}
\hline
$\textcolor{white}{\mathbf{\Sigma}}\mathbf{S_{p \times p}}$ & $X_1$ & $X_2$ & $\cdots$ & $X_p$ \\  \hline  \hline
$X_1$ & $\hat \sigma_{11}^2$ & $\hat \sigma_{12}^2$ && $\hat \sigma_{1p}^2$ \\  \hline
$X_2$ &$\hat \sigma_{21}^2$  &$\hat \sigma_{22}^2$ && $\hat \sigma_{2p}^2$ \\ \hline
$\vdots$ &&$\ddots$&& \\ \hline
$X_p$ &$\hat \sigma_{p1}^2$ &$\hat \sigma_{p2}^2$ && $\hat \sigma_{pp}^2$ \\ \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|r||l|l|l|l|}
\hline
 $\textcolor{white}{\mathbf{\Sigma}}\mathbf{\hat r_{p \times p}}$ & $X_1$ & $X_2$ & $\cdots$ & $X_p$ \\  \hline\hline
$X_1$ & $1$ & $\hat r_{12}$ && $\hat r_{1p}^{\;}$ \\  \hline
$X_2$ &$\hat r_{21}$  &$1$ && $\hat r_{2p}^{\;}$ \\ \hline
$\vdots$ &&$\ddots$&& \\ \hline
$X_p$ &$\hat r_{p1}$ &$\hat r_{p2}^{\;}$ && $1$ \\ \hline
\end{tabular}
\end{table}
...
The \emph{\textcolor{NavyBlue}{eigenvectors} and \textcolor{NavyBlue}{eigenvalues}} of a linear 
transformation ${\boldsymbol \Sigma}_{p \times p}$ are orthonormal vectors $v$ and constants $\lambda$ satisfying
$${\boldsymbol \Sigma} v = \lambda v \quad \textcolor{gray}{\text{ as opposed to } \quad {\boldsymbol \Sigma} w = w'}$$
\vspace{-1em}
$$
\left[\begin{array}{cc}2&0\\0&1\end{array}\right] \left[\begin{array}{cc}1\\0\end{array}\right] = 2\left[\begin{array}{cc}1\\0\end{array}\right] 
\quad\quad
...
\onslide<2->{
\textcolor{red}{The eigenvalues further point towards high variance axes}, e.g.
...
n &&&& \\ \hline
\end{tabular}
\textcolor{red}{$\overset{\boldsymbol \Sigma}{ \longrightarrow}$}
\begin{tabular}{|r||l|l|l|l|}
\hline
